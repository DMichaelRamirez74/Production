...
namespace FingerprintsData
{
    public class RosterData
    {
        ...
        volatile StaffDetails staff;

        public RosterData()
        {
            staff = Fingerprints.Common.FactoryInstance.Instance.CreateInstance<StaffDetails>();
        }

        public RosterData(StaffDetails staffDetails)
        {
            staff = staffDetails;
        }

        public List<Roster> Getrosterclient()
        {
        ...
        public CaseNoteByClientID GetCaseNote(ref string Name, CaseNoteByClientID caseNoteByClientID)
        {
            caseNoteByClientID.CaseNoteList = new List<CaseNote>();

            //  var userList = new RosterNew.Users();
            ...
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@CenterID",caseNoteByClientID.CenterID!=null && caseNoteByClientID.CenterID!="" && caseNoteByClientID.CenterID!="0"? Convert.ToInt64(EncryptDecrypt.Decrypt64(caseNoteByClientID.CenterID)):0,DbType.Int64),
                    dbManager.CreateParameter("@Householdid",Convert.ToInt64(EncryptDecrypt.Decrypt64(caseNoteByClientID.Enc_HouseholdID)),DbType.Int64),
                    dbManager.CreateParameter("@ClientID",Convert.ToInt64(EncryptDecrypt.Decrypt64(caseNoteByClientID.Enc_ClientID)),DbType.Int64),
                    dbManager.CreateParameter("@Take",caseNoteByClientID.PageSize,DbType.Int32),
                    dbManager.CreateParameter("@Skip", caseNoteByClientID.SkipRows,DbType.Int32),
                    dbManager.CreateParameter("@SortOrder",caseNoteByClientID.SortOrder,DbType.String),
                    dbManager.CreateParameter("@SortColumn",caseNoteByClientID.SortColumn,DbType.String),
                    dbManager.CreateParameter("@TotalRecord",10,caseNoteByClientID.TotalRecord,DbType.Int32,ParameterDirection.Output),
                    dbManager.CreateParameter("@IncludeOtherStaffNotes", caseNoteByClientID.IncludeNotesByOtherStaffs,DbType.Boolean),
                    dbManager.CreateParameter("@Tagnames",caseNoteByClientID.TagNames,DbType.String),
                    dbManager.CreateParameter("@IsCaseNoteManager",caseNoteByClientID.IsCaseNoteManager, DbType.Boolean)
            };

                _dataset = dbManager.GetDataSet("SP_Getcasenotes", CommandType.StoredProcedure, parameters);

                caseNoteByClientID.TotalRecord = Convert.ToInt32(parameters.Where(x => x.ParameterName == "@TotalRecord" && x.Direction == ParameterDirection.Output).Select(x => x.Value).FirstOrDefault());
                caseNoteByClientID.CaseNoteList = new List<CaseNote>();
                ...
                if (_dataset != null && _dataset.Tables.Count > 0 && _dataset.Tables[0] != null)
                {
                    if (_dataset.Tables[0].Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dr in _dataset.Tables[0].Rows)
                        {
                            ...
                            info.ClientId = Convert.ToString(dr["ClientId"]);
                            ...
                            info.Date = !string.IsNullOrEmpty(Convert.ToString(dr["CaseNOteDate"])) ? Convert.ToDateTime(Convert.ToString(dr["CaseNoteDate"]), new CultureInfo("en-US", true)).ToString("MMMM dd, yyyy") : string.Empty;
                            ...
                            caseNoteByClientID.CaseNoteList.Add(info);
                        }
                    }

                    if (_dataset.Tables.Count > 1 && _dataset.Tables[1] != null && _dataset.Tables[1].Rows.Count > 0)
                    {
                        Name = Convert.ToString(_dataset.Tables[1].Rows[0]["ClientName"]);
                    }

                }


                //    SetCaseNoteDetails(caseNoteByClientID.CaseNoteList, ref Name, ref userList, _dataset);

                //caseNoteByClientID.UserList = userList.UserList;
                //caseNoteByClientID.Clientlist = userList.Clientlist;
            }
            catch (Exception ex)
            {
                clsError.WriteException(ex);
        ...
        //  public CaseNoteByClientID GetoCaseNoteByTags(ref string Name, int Householdid, int centerid, string id, string AgencyId, string UserId, string Tagnames, int IsFromFamilySummary)

        public CaseNoteByClientID GetCaseNoteByTags(CaseNoteByClientID caseNoteByClientID, int IsFromFamilySummary)
        {
            ...
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                   ...
                   dbManager.CreateParameter("@RoleID",staff.RoleId,DbType.Guid),
                   dbManager.CreateParameter("@UserID",staff.UserId,DbType.Guid),
                   dbManager.CreateParameter("@HouseholdId",long.TryParse(caseNoteByClientID.Enc_HouseholdID, out _testType)?caseNoteByClientID.Enc_HouseholdID: EncryptDecrypt.Decrypt64(caseNoteByClientID.Enc_HouseholdID) ,DbType.Int64),
                   dbManager.CreateParameter("@ClientId",long.TryParse(caseNoteByClientID.Enc_ClientID,out _testType)? caseNoteByClientID.Enc_ClientID:EncryptDecrypt.Decrypt64(caseNoteByClientID.Enc_ClientID) ,DbType.Int64),
                   dbManager.CreateParameter("@CenterId",long.TryParse(caseNoteByClientID.CenterID, out _testType)? caseNoteByClientID.CenterID:EncryptDecrypt.Decrypt64(caseNoteByClientID.CenterID),DbType.Int64),
                   dbManager.CreateParameter("@Tagnames",caseNoteByClientID.TagNames,DbType.String),
                   dbManager.CreateParameter("@IsFromFamilySummary",IsFromFamilySummary,DbType.Boolean),
                   dbManager.CreateParameter("@SortOrder",caseNoteByClientID.SortOrder,DbType.String),
                   dbManager.CreateParameter("@SortColumn", caseNoteByClientID.SortColumn,DbType.String),
                   dbManager.CreateParameter("@Take" ,caseNoteByClientID.PageSize,DbType.Int32),
                   dbManager.CreateParameter("@Skip",caseNoteByClientID.SkipRows,DbType.Int32),
                   dbManager.CreateParameter("@TotalRecord",8,caseNoteByClientID.TotalRecord,DbType.Int32,ParameterDirection.Output)
                };

                _dataset = dbManager.GetDataSet("SP_GetcasenotesByTags", CommandType.StoredProcedure, parameters);
                ...
                if (_dataset != null && _dataset.Tables.Count > 0 && _dataset.Tables[0] != null)
                {
                    if (_dataset.Tables[0].Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dr in _dataset.Tables[0].Rows)
                        {
                            ...
                            info.Attachment = dr["Attachment"].ToString();
                            info.References = dr["References"].ToString();
                            info.Date = Convert.ToDateTime(dr["casenotedate"].ToString(), new CultureInfo("en-US", true)).ToString("MMMM dd, yyyy");
                            info.SecurityLevel = Convert.ToBoolean(dr["SecurityLevel"]);
                            info.IsAllowSecurityCN = Convert.ToBoolean(dr["isAllowSecurityCN"]);
                            info.WrittenBy = Convert.ToString(dr["WrittenBy"]);
                            info.IsEditable = Convert.ToBoolean(dr["Editable"]);
                ...
                //command.Parameters.Add(new SqlParameter("@Agencyid", staff.AgencyId));
                //command.Parameters.Add(new SqlParameter("@userid", staff.UserId));
                //command.Parameters.Add(new SqlParameter("@clientid", casenoteByClientID.CaseNote.ClientId));
                //command.Parameters.Add(new SqlParameter("@centerid", casenoteByClientID.CaseNote.CenterId));
                //command.Parameters.Add(new SqlParameter("@Householdid", casenoteByClientID.CaseNote.CenterId));
                //command.Parameters.Add(new SqlParameter("@Tagnames", casenoteByClientID.CaseNote.Tagname));
                //command.Parameters.Add(new DailySaftyCheckImages)
                //command.Parameters.Add(new SqlParameter("@IsFromFamilySummary", IsFromFamilySummary));
                //command.Connection = Connection;
                //command.CommandType = CommandType.StoredProcedure;
                //command.CommandText = "SP_GetcasenotesByTags";
        ...
        public void GetCaseNotesByClient(ref DataTable dtCaseNote, string id, string householdID)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@Householdid", householdID));
                command.Parameters.Add(new SqlParameter("@IncludeOtherStaffNotes", true));
                command.Connection = Connection;
                command.CommandType = CommandType.StoredProcedure;
        ...
        public CaseNoteByClientID GetCaseNoteByClientId(CaseNoteByClientID caseNoteByClient)
        {

            caseNoteByClient.CaseNoteList = Fingerprints.Common.FactoryInstance.Instance.CreateInstance<List<CaseNote>>();
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@RoleID",staff.RoleId,DbType.Guid),
                    dbManager.CreateParameter("@UserID",staff.UserId,DbType.Guid),
                    dbManager.CreateParameter("@Householdid",Convert.ToInt64(EncryptDecrypt.Decrypt64(caseNoteByClient.Enc_HouseholdID)),DbType.Int64),
                    dbManager.CreateParameter("@ClientID",Convert.ToInt64(EncryptDecrypt.Decrypt64(caseNoteByClient.Enc_ClientID)),DbType.Int64),
                    dbManager.CreateParameter("@IncludeOtherStaffNotes",caseNoteByClient.IncludeNotesByOtherStaffs,DbType.Boolean)

                };

                _dataset = dbManager.GetDataSet("SP_GetcasenotesByClientId", CommandType.StoredProcedure, parameters);

                string Name = string.Empty;
                FingerprintsModel.RosterNew.Users userList = new RosterNew.Users();
                SetCaseNoteDetails(caseNoteByClient.CaseNoteList, ref Name, ref userList, _dataset);

                caseNoteByClient.UserList = userList.UserList;
                caseNoteByClient.Clientlist = userList.Clientlist;
            }
            catch (Exception ex)
            {
                clsError.WriteException(ex);
        ...
        public CaseNoteByClientID GetCaseNoteByCaseNoteId(CaseNoteByClientID caseNoteByClientId)
        {
            try
            {
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@RoleID",staff.RoleId,DbType.Guid),
                    dbManager.CreateParameter("@UserID",staff.UserId,DbType.Guid),
                    dbManager.CreateParameter("@CaseNoteID",caseNoteByClientId.CaseNote.CaseNoteid,DbType.String),
                    dbManager.CreateParameter("@ClientID",caseNoteByClientId.CaseNote.ClientId,DbType.String),
                    dbManager.CreateParameter("@HouseholdID",caseNoteByClientId.CaseNote.HouseHoldId,DbType.String),
                };


                _dataset = dbManager.GetDataSet("USP_GetCaseNoteByCaseNoteID", CommandType.StoredProcedure, parameters);
                ...
                if (_dataset != null && _dataset.Tables.Count > 0)
                {
                    ...
                    if (_dataset.Tables[0] != null && _dataset.Tables[1].Rows.Count > 0)
                    {


                        caseNoteByClientId.CaseNote = (from DataRow dr0 in _dataset.Tables[0].Rows
                                                       select new CaseNote
                                                       {
                                                           CaseNoteid = Convert.ToString(dr0["CaseNoteID"]),
                                                           CaseNoteDate = Convert.ToString(dr0["CaseNoteDate"]),
                                                           ActualWrittenDateTime = dr0["ActualWrittenDateTime"] != DBNull.Value && Convert.ToString(dr0["ActualWrittenDateTime"]) != "" ? Convert.ToString(dr0["ActualWrittenDateTime"]) : string.Empty,
                                                           Title = Convert.ToString(dr0["Title"]),
                                                           Note = Convert.ToString(dr0["NoteField"]),
                                                           //WrittenBy=Convert.ToString(dr0["WrittenBy"]),
                                                           BY = Convert.ToString(dr0["WrittenBy"]),
                                                           RoleOfOwner = Convert.ToString(dr0["RoleOfOwner"]),
                                                           SecurityLevel = Convert.ToBoolean(dr0["SecurityLevel"]),
                                                           GroupCaseNote = Convert.ToString(dr0["GroupCaseNote"]),
                                                           TagList = (from DataRow dr1 in _dataset.Tables[1].Rows
                                                                      where Convert.ToString(dr1["CaseNoteID"]) == caseNoteByClientId.CaseNote.CaseNoteid
                                                                      select new SelectListItem
                                                                      {
                                                                          Text = Convert.ToString(dr1["TagName"]),
                                                                          Value = Convert.ToString(dr1["TagKey"])

                                                                      }).ToList(),
                                                           CaseNoteAttachmentList = (from DataRow dr2 in _dataset.Tables[2].Rows
                                                                                     where Convert.ToString(dr2["CaseNoteID"]) == caseNoteByClientId.CaseNote.CaseNoteid
                                                                                     select new RosterNew.Attachment
                                                                                     {
                                                                                         AttachmentId = Convert.ToInt64(dr2["AttachmentId"]),
                                                                                         //AttachmentFileExtension = Convert.ToString(dr2["AttachmentExtension"]),
                                                                                         //AttachmentFileName = Convert.ToString(dr2["AttachmentName"])
                    ...
                    //if (_dataset.Tables.Count > 1 && caseNoteByClientId != null && caseNoteByClientId.CaseNote != null)
                    //{
                    //    caseNoteByClientId.CaseNote.TagList = (from DataRow dr1 in _dataset.Tables[1].Rows
                    //                                           where Convert.ToString(dr1["CaseNoteID"]) == caseNoteByClientId.CaseNote.CaseNoteid
                    //                                           select new SelectListItem
                    //                                           {
                    //                                               Text = Convert.ToString(dr1["TagName"]),
                    ...
                    //if(_dataset.Tables.Count>2 && caseNoteByClientId!=null && caseNoteByClientId.CaseNote!=null)
                    //{
                    //    caseNoteByClientId.CaseNote.CaseNoteAttachmentList = (from DataRow dr2 in _dataset.Tables[2].Rows
                    //                                                          where Convert.ToString(dr2["CaseNoteID"]) == caseNoteByClientId.CaseNote.CaseNoteid
                    //                                                          select new RosterNew.Attachment
                    //                                                          {
                    //                                                              AttachmentId = Convert.ToInt64(dr2["AttachmentId"]),
                    ...
                    if (_dataset.Tables.Count > 3 && caseNoteByClientId != null && caseNoteByClientId.CaseNote != null)
                    {
                        caseNoteByClientId.CaseNote.SubCaseNoteList = (from DataRow dr3 in _dataset.Tables[3].Rows
                                                                       where Convert.ToString(dr3["CaseNoteID"]) == caseNoteByClientId.CaseNote.CaseNoteid
                                                                       select new SubCaseNote
                                                                       {
                                                                           SubCasenoteid = Convert.ToString(dr3["SubCaseNoteId"]),
                                                                           WrittenDate = Convert.ToString(dr3["SubCaseNoteDate"]),
                                                                           ActualWrittenDateTime = dr3["ActualWrittenDateTime"] != DBNull.Value && Convert.ToString(dr3["ActualWrittenDateTime"]) != "" ? Convert.ToString(dr3["ActualWrittenDateTime"]) : string.Empty,

                                                                           WrittenBy = Convert.ToString(dr3["WrittenBy"]),
                                                                           RoleOfOwner = Convert.ToString(dr3["RoleOfOwner"]),
                                                                           Notes = Convert.ToString(dr3["NoteField"]),
                                                                           TagList = (from DataRow dr4 in _dataset.Tables[4].Rows
                                                                                      where Convert.ToString(dr4["SubCaseNoteId"]) == Convert.ToString(dr3["SubCaseNoteId"])
                                                                                      select new SelectListItem
                                                                                      {
                                                                                          Text = Convert.ToString(dr4["TagName"]),
                                                                                          Value = Convert.ToString(dr4["TagKey"])
                                                                                      }).ToList(),
                                                                           Attachment = (from DataRow dr5 in _dataset.Tables[5].Rows
                                                                                         where Convert.ToString(dr5["SubCaseNoteId"]) == Convert.ToString(dr3["SubCaseNoteId"])
                                                                                         select Convert.ToString(dr5["AttachmentId"])
                                                                                       ).ToList()
                    ...
                    if (_dataset.Tables.Count > 6 && caseNoteByClientId != null && caseNoteByClientId.CaseNote != null)
                    {
                        caseNoteByClientId.CaseNote.ClientList = (from DataRow dr6 in _dataset.Tables[6].Rows
                                                                  select new SelectListItem
                                                                  {
                                                                      Text = Convert.ToString(dr6["ClientName"]),
                                                                      Value = Convert.ToString(dr6["ClientId"]),
                                                                      Selected = Convert.ToBoolean(dr6["Selected"])
                                                                  }
                    ...
                    if (_dataset.Tables.Count > 7 && caseNoteByClientId != null && caseNoteByClientId.CaseNote != null)
                    {
                        caseNoteByClientId.CaseNote.StaffList = (from DataRow dr7 in _dataset.Tables[7].Rows
                                                                 select new SelectListItem
                                                                 {
                                                                     Text = Convert.ToString(dr7["Name"]),
                                                                     Value = Convert.ToString(dr7["UserId"]),
                                                                     Selected = Convert.ToBoolean(dr7["Selected"])
                                                                 }

                                                            ).ToList();
                    }

                    if (_dataset.Tables.Count > 8 && caseNoteByClientId != null && caseNoteByClientId != null)
                    {
                        caseNoteByClientId.Enc_ClientID = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[8].Rows[0]["ClientID"]));
                        caseNoteByClientId.CenterID = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[8].Rows[0]["CenterID"]));
                        caseNoteByClientId.ClassroomID = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[8].Rows[0]["ClassroomID"]));
                        caseNoteByClientId.ProgramId = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[8].Rows[0]["ProgramId"]));
                        caseNoteByClientId.CenterName = Convert.ToString(_dataset.Tables[8].Rows[0]["CenterName"]);
                        caseNoteByClientId.ClassroomName = Convert.ToString(_dataset.Tables[8].Rows[0]["ClassroomName"]);
                    ...
                    if (_dataset.Tables[1].Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dr in _dataset.Tables[1].Rows)
                        {
                            ...
                            if (subnotesCount > 0 && !casenoteids.Contains(subCasenote.SubCasenoteid))
                            {
                                ...
                                subCasenote.RoleOfOwner = dr["RoleOfOwner"].ToString();
        ...
        public bool SaveSubNotes(RosterNew.CaseNote _caseNote)
        {

            bool isRowsAffected = false;
            try
            {
                _caseNote.CaseNotetags = !string.IsNullOrEmpty(_caseNote.CaseNotetags) ? _caseNote.CaseNotetags.Trim(',').TrimEnd(',') : string.Empty;
                ...
                if (_caseNote.CaseNoteAttachmentList != null)
                {



                    foreach (RosterNew.Attachment Attachment in _caseNote.CaseNoteAttachmentList)
                    {
                ...
                var parameters = new IDbDataParameter[]
                {
                    dbManager.CreateParameter("@CaseNoteID",_caseNote.CaseNoteid,DbType.String),
                    dbManager.CreateParameter("@AgencyID",staff.AgencyId,DbType.Guid),
                    dbManager.CreateParameter("@Householdid",_caseNote.HouseHoldId,DbType.String),
                    dbManager.CreateParameter("@CaseNoteTags",_caseNote.CaseNotetags,DbType.String),
                    dbManager.CreateParameter("@SubCaseNoteDate",_caseNote.CaseNoteDate,DbType.String),
                    dbManager.CreateParameter("@WrittenBy",staff.UserId,DbType.Guid),
                    dbManager.CreateParameter("@RoleOfOwner",staff.RoleId,DbType.Guid),
                    dbManager.CreateParameter("@Note",_caseNote.Note,DbType.String),
                    dbManager.CreateParameter("@CenterId",_caseNote.CenterId,DbType.String),
                    dbManager.CreateParameter("@ClassroomId",_caseNote.Classroomid,DbType.String),
                    dbManager.CreateParameter("@Attachments",dt,DbType.Object)
                };


                isRowsAffected = dbManager.ExecuteWithNonQuery<bool>("USP_AddSubNotes", CommandType.StoredProcedure, parameters);
        ...
        public List<CaseNote> GetcaseNoteDetail(string Casenoteid, string ClientId)
        {
            CaseNoteByClientID caseNoteByClientId = Fingerprints.Common.FactoryInstance.Instance.CreateInstance<CaseNoteByClientID>();
            caseNoteByClientId.CaseNoteList = Fingerprints.Common.FactoryInstance.Instance.CreateInstance<List<CaseNote>>();
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                    dbManager.CreateParameter("@AgencyID",staff.AgencyId,DbType.Guid),
                    dbManager.CreateParameter("@UserID",staff.UserId,DbType.Guid),
                    dbManager.CreateParameter("@casenotid",Casenoteid,DbType.String),
                    dbManager.CreateParameter("@ClientID",ClientId,DbType.String)
                };

                _dataset = dbManager.GetDataSet("SP_Getcasenote", CommandType.StoredProcedure, parameters);
            ...
            return caseNoteByClientId.CaseNoteList;
        }
        ...
        public bool SaveAttachmentsOnSubNote(string CaseNoteId, byte[] file, string AttachmentName, string AttachmentExtension, string Subcasenoteid)
        {
        ...
        // ref List<CaseNote> CaseNoteList, ref FingerprintsModel.RosterNew.Users Userlist,
        public string SaveCaseNotes(ref string Name, RosterNew.CaseNote caseNote, int mode = 2)
        {
            ...
            try
            {
                ...
                caseNote.CaseNoteid = caseNote.CaseNoteid != null && caseNote.CaseNoteid != "" ? caseNote.CaseNoteid : "0";
                caseNote.ClientId = caseNote.ClientId != null && caseNote.ClientId != "" && caseNote.ClientId != "0" ? long.TryParse(caseNote.ClientId, out _typeTest) ? caseNote.ClientId : EncryptDecrypt.Decrypt64(caseNote.ClientId) : "0";
                caseNote.ProgramId = caseNote.ProgramId != null && caseNote.ProgramId != "" && caseNote.ProgramId != "0" ? long.TryParse(caseNote.ProgramId, out _typeTest) ? caseNote.ProgramId : EncryptDecrypt.Decrypt64(caseNote.ProgramId) : "0";
                caseNote.CenterId = caseNote.CenterId != null && caseNote.CenterId != "" && caseNote.CenterId != "0" ? long.TryParse(caseNote.CenterId, out _typeTest) ? caseNote.CenterId : EncryptDecrypt.Decrypt64(caseNote.CenterId) : "0";
                caseNote.Classroomid = caseNote.Classroomid != null && caseNote.Classroomid != "" && caseNote.Classroomid != "0" ? long.TryParse(caseNote.Classroomid, out _typeTest) ? caseNote.Classroomid : EncryptDecrypt.Decrypt64(caseNote.Classroomid) : "0";
                caseNote.HouseHoldId = caseNote.HouseHoldId != null && caseNote.HouseHoldId != "" && caseNote.HouseHoldId != "0" ? long.TryParse(caseNote.HouseHoldId, out _typeTest) ? caseNote.HouseHoldId : EncryptDecrypt.Decrypt64(caseNote.HouseHoldId) : "0";
                ...
                foreach (RosterNew.Attachment Attachment in caseNote.CaseNoteAttachmentList ?? new List<RosterNew.Attachment>())
                {
                    if (Attachment != null && Attachment.file != null)
                    {
                        dt.Rows.Add(new BinaryReader(Attachment.file.InputStream).ReadBytes(Attachment.file.ContentLength), Attachment.file.FileName, Path.GetExtension(Attachment.file.FileName));
                    ...
                    else if (Attachment.AttachmentJson != null && Attachment.AttachmentJson.Trim() != string.Empty)
                    {
                        dt.Rows.Add(Convert.FromBase64String(Attachment.AttachmentJson), Attachment.AttachmentFileName, Attachment.AttachmentFileExtension);
                    }
                }
        ...
        public Roster GetrosterList(out int totalRecords, RosterViewModel rosterViewModel)

        {
            ...
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                    dbManager.CreateParameter("@Center",rosterViewModel.CenterId,DbType.Int64),
                    dbManager.CreateParameter("@Classroom",rosterViewModel.ClassroomId,DbType.Int64),
                    dbManager.CreateParameter("@Take",rosterViewModel.PageSize,DbType.Int32),
                    dbManager.CreateParameter("@Skip",rosterViewModel.SkipRows,DbType.Int32),
                    dbManager.CreateParameter("@SortOrder",rosterViewModel.SortOrder,DbType.String),
                    dbManager.CreateParameter("@SortColumn",rosterViewModel.SortColumn,DbType.String),
                    dbManager.CreateParameter("@SearchText",rosterViewModel.SearchTerm,DbType.String),
                    dbManager.CreateParameter("@FilterOption",rosterViewModel.FilterOption,DbType.String),
                    dbManager.CreateParameter("@AgencyID",staff.AgencyId,DbType.Guid),
                    dbManager.CreateParameter("@RoleID",staff.RoleId,DbType.Guid),
                    dbManager.CreateParameter("@UserID",staff.UserId,DbType.Guid)
                ...
                IDataReader dr = dbManager.GetDataReader("SP_rosterList", CommandType.StoredProcedure, parameters, out connection);
                            ...
                            case 0:
                                ...
                                _roster.Rosters.Add(
                                                    new Roster
                                                    {
                                                        ...
                                                        AttendanceIssueYakkrId = DBNull.Value.Equals(dr["AttendanceIssueYakkrId"]) ? "0" : EncryptDecrypt.Encrypt64(Convert.ToString(dr["AttendanceIssueYakkrId"])),
                                                        ...
                                                        IsAllowAttendanceIssueReview = Convert.ToString(dr["FamilyAdvocate"]).ToLowerInvariant() == staff.UserId.ToString().ToLowerInvariant()
        ...
        public void MarkAbsent(ref string result, string ChildID, string absentType, string cNotes, int AbsentReasonid, string NewReason)
        {
            ...
            try
            {
                ...
                if (absentType == "1")
                {
                    ...
                    command.Parameters.Add(new SqlParameter("@Notes", cNotes));
                    command.Parameters.Add(new SqlParameter("@result", string.Empty));
        ...
        public List<REF> AutoCompleteSerType(string Services, Guid? agencyId)
        {
        ...
        public List<ClassRoom> Getclassrooms(string Centerid, bool isEndOfYear = false, bool isInkind = false)
        {
        ...
        public string AddFPA(FPA info, int mode)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                command.Parameters.AddWithValue("@CreatedBy", staff.UserId);
        ...
        //--------------------------------------------------------------------------------------------------------
        public List<MatchProviderModel> MatchProviders(string CommunityId, long? ReferralClientId)
        {
        ...
        public MatchProviderModel FamilyResourcesList(int ServiceId, Guid AgencyId)
        {
            DataSet ds = null;
        ...
        public List<SelectListItem> FamilyServiceList(long ServiceId)
        {
            try
            {
                DataSet ds = null;
        ...
        //End
        //rohit 01032017
        public List<CaseNote> GetgroupcaseNoteDetail(string Casenoteid)
        {
            List<CaseNote> CaseNoteList = new List<CaseNote>();
            try
            {
        ...
        public List<SurveyOptions> LoadSurveyOptions(long ReferralClientId)
        {
        ...
        public void InsertSurveyOptions(List<SurveyOptions> options, long ReferralClientId, bool isUpdate)
        {
        ...
        public List<BusinessHours> BusinessHoursList(string ServiceId, string CommunityID)
        {
        ...
        public List<SelectListItem> FamilyServiceList(int ServiceId)
        {
            try
            {
                DataSet ds = null;
        ...
        public List<SelectListItem> GetServiceReference(Guid? agencyId)
        {
        ...
        public List<SelectListItem> FamilyServiceListCompany(Int32 ServiceId)
        {
            try
            {
                DataSet ds = null;
        ...
        public List<SelectListItem> GetReferralType(int communityId)
        {
            List<SelectListItem> selectedlist = new List<SelectListItem>();
            DataSet ds = new DataSet();
            command.Connection = Connection;
        ...
        public MatrixScore GetMatrixScoreList(long Householdid, long clientId, long programId)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        score.ParentGender = Convert.ToString(dr["Gender"]);
                    }
                }
                if (ds.Tables[1].Rows.Count > 0)
                {
        ...
        public void GetChildlistByUserId(ref ObservationNotes objNotes)
        {
            objNotes = new ObservationNotes();
            try
            {
        ...
        public List<AttendenceDetailsByDate> GetAttendenceDetailsByDate(out int totalRecord, AttendanceMealAuditReport report, StaffDetails staff)
        {
        ...
        public List<SeatAvailability> SaveChildHeadStartTranstion(TransitionDetails Transition, bool isStatusChange = false)
        {
            ...
            try
            {
                ...
                if (Transition.Transition.CaseNoteDetails.CaseNoteAttachmentList != null && Transition.Transition.CaseNoteDetails.CaseNoteAttachmentList.Count > 0)
                {
                    ...
                    foreach (RosterNew.Attachment Attachment in Transition.Transition.CaseNoteDetails.CaseNoteAttachmentList)
                    {
                        ...
                        else if (Attachment != null && Attachment.AttachmentJson != null && Attachment.AttachmentJson.Trim() != string.Empty)
                        {
                            dt.Rows.Add(Convert.FromBase64String(Attachment.AttachmentJson), Attachment.AttachmentFileName, Attachment.AttachmentFileExtension);
                ...
                if (((Transition.Transition.TypeOfTransition == 10 || Transition.Transition.TypeOfTransition == 9) && Transition.Transition.NewProgramYearTransition == false) || (isStatusChange))
                {
                    ...
                    foreach (PregMomChilds objChild in Transition.PregMomChilds)
                    {
                        ...
                        command.Parameters.Add(new SqlParameter("@ClientIds", Transition.Transition.CaseNoteDetails.ClientIds));
                        command.Parameters.Add(new SqlParameter("@StaffIds", Transition.Transition.CaseNoteDetails.StaffIds));
        ...
        public int SaveHeadStartTranstion(Transition Transition, StaffDetails staff)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@SchoolAchievement", Transition.SchoolAchievement));
                ...
                command.Parameters.Add(new SqlParameter("@SchoolAchievement2", Transition.SchoolAchievement2));
        ...
        public bool SaveCenterOrClassroomChange(string clientId, string dateOfTransition, string centerId, string classroomId, StaffDetails staff, int? reasonId, string newReason)
        {
            bool isInserted = false;
            //  int resultValue = 0;
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@DateOfTransition",dateOfTransition,DbType.String),
                    dbManager.CreateParameter("@ReasonId",reasonId??0,DbType.Int32),
                    dbManager.CreateParameter("@NewReason",newReason,DbType.String),
                    dbManager.CreateParameter("@CenterId",centerId,DbType.Int64),
                    dbManager.CreateParameter("@ClassroomId",classroomId,DbType.Int64)
                };

                var result = dbManager.ExecuteWithScalar<int>("USP_InsertCenterAndClassRoom", CommandType.StoredProcedure, parameters);
        ...
        public bool InsertParentDetailsMatrixScore(MatrixScore matrixScore)
        {
            bool isRowsAffected = false;
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@AgencyId",staff.AgencyId,DbType.Guid),
                    dbManager.CreateParameter("@UserId",staff.UserId,DbType.Guid),
                    dbManager.CreateParameter("@HouseholdId",matrixScore.Dec_HouseHoldId,DbType.Int64),
                    dbManager.CreateParameter("@ParentId",matrixScore.ParentId,DbType.Int64),
                    dbManager.CreateParameter("@IsChecked",matrixScore.IsChecked,DbType.Boolean),
                    dbManager.CreateParameter("@ProgramTypeYear",matrixScore.ActiveYear,DbType.String),
                    dbManager.CreateParameter("@AssessmentNumber",matrixScore.AssessmentNumber,DbType.Int32)
                };

                isRowsAffected = dbManager.ExecuteWithNonQuery<bool>("SP_InsertParentDetails_Assessmnt", CommandType.StoredProcedure, parameters);
                ...
                //command.Parameters.Add(new SqlParameter("@ProgramTypeYear", matrixScore.ActiveYear));
                //command.Parameters.Add(new SqlParameter("@HouseHoldId", matrixScore.Dec_HouseHoldId));
                //command.Parameters.Add(new SqlParameter("@AssessmentNumber", matrixScore.AssessmentNumber));
            ...
            try
            {
                ...
                using (Connection = connection.returnConnection())
                {
                    ...
                    string query = @"select Name = (Firstname + ' ' + Lastname), DOB = (convert(varchar(10), DOB, 101)), ProfilePic,
                         ED.ProgramID,PD.ProgramType from Client C left join EnrollmentDetail ED
                          on C.ClientID = ED.ClientID and C.Status = 1 and ED.Status in (0,1,4,5) and ED.IsActive = 0
                          left join ProgramDetails PD on PD.ProgramTypeID = ED.ProgramID 
where C.ClientID = {0} ; select PD.ProgramType,Ed.ProgramID from Client C
left join EnrollmentDetail ED on C.ClientID = ED.ClientID and C.Status = 1
 left join
...
";
        ...
        public List<ClientTimeLineModel> GetTimelineMaster()
        {

            List<ClientTimeLineModel> clientTimeline = new List<ClientTimeLineModel>();
            try
            {
                DataTable dt = dbManager.GetDataTable("USP_GetTimelineMaster", CommandType.StoredProcedure, null);

                if (dt != null && dt.Rows.Count > 0)
                {
                    clientTimeline = DbHelper.DataTableToList<ClientTimeLineModel>(dt, new List<string>());
                }
        ...
        public List<ClientTimeLineModel> GetClientTimeLine(long clientid, string stepIds)
        {
            ...
            try
            {
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@RoleId",staff.RoleId,DbType.Guid),
                    dbManager.CreateParameter("@ClientId",clientid,DbType.Int64),
                    dbManager.CreateParameter("@StepIds",stepIds,DbType.String)
                };

                var _dataTable = dbManager.GetDataTable("USP_TimeLineDetails", CommandType.StoredProcedure, parameters);

                result = DbHelper.DataTableToList<ClientTimeLineModel>(_dataTable, new List<string>());

                int order = 1;

                HashSet<ClientTimeLineModel> clientModel = new HashSet<ClientTimeLineModel>();

                for (int i = 0; i < result.Count; i++)
                {

                    if (new long[] { 2,11, 12, 13, 14, 17, 18 }.Contains(result[i].StepId))//Accepted //Date of Withdrawn // Date of Dropped // Date of Transition // Re-Enrollment //Change of Address 
                    {

                        result[i].TimelineOrder = order;
                        clientModel.Add(result[i]);
                        order++;
                        ClientTimeLineModel cNote = null; 



                        switch(result[i].StepId)
                        {
                            case 11: // Date of Withdrawn//

                                cNote = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 10 && x.EventBodyJson.ToLowerInvariant().Contains("withdrawn")).FirstOrDefault();

                                break;

                            case 12:// Date of Dropped //

                                cNote = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 10 && x.EventBodyJson.ToLowerInvariant().Contains("dropped")).FirstOrDefault();

                                break;
                            case 13://Re-enrollment//
                                cNote = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 10 && x.EventBodyJson.ToLowerInvariant().Contains("re-enrolled")).FirstOrDefault();

                                break;
                            case 14: //Date of Transition//

                                var withdrawnTransaction = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 11).FirstOrDefault();

                                if(withdrawnTransaction!=null)
                                {
                                    withdrawnTransaction.TimelineOrder = order;
                                    order++;
                                    clientModel.Add(withdrawnTransaction);
                                }
                                cNote = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 10 && x.EventBodyJson.ToLowerInvariant().Contains("transition")).FirstOrDefault();
                                break;
                            case 17: //Change of Address//
                                cNote = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 10 && x.EventBodyJson.ToLowerInvariant().Contains("address")).FirstOrDefault();
                                break;
                            case 18://Center/Classroom Change//
                                cNote = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 10 && (x.EventBodyJson.ToLowerInvariant().Contains("center change") || x.EventBodyJson.ToLowerInvariant().Contains("classroom change"))).FirstOrDefault();
                                break;
                        }

                        if (cNote != null)
                        {
                            cNote.TimelineOrder = order;
                            clientModel.Add(cNote);
                            order++;
                        }

                        if(result[i].StepId==14)
                        {
                            var accpetedTransaction = result.Where(x => x.EventCreatedDate == result[i].EventCreatedDate && x.StepId == 2).FirstOrDefault();
                            if (accpetedTransaction != null) //Accepted Transaction//
                            {
                                accpetedTransaction.TimelineOrder = order;
                                clientModel.Add(accpetedTransaction);
                                order++;
                            }
                        }
                    }
                ...
                result = new List<ClientTimeLineModel>(clientModel).OrderBy(x=>x.TimelineOrder).ToList();
                result.ForEach(x =>
                {
                    XmlDocument doc = new XmlDocument();
                    doc.LoadXml(x.EventBodyJson);
                    x.EventBodyJson = JsonConvert.SerializeXmlNode(doc);
                });
        ...
        public CaseNoteByClientID GetDevelopmentalMembersByClientID(long clientId, StaffDetails staffDetails, int yakkrcode = 0)
        {
            ...
            try
            {
                ...
                clientCaseNote.CaseNote = new CaseNote();
                clientCaseNote.CaseNoteList = new List<CaseNote>();
                clientCaseNote.UserList = new List<RosterNew.User>();
                clientCaseNote.Clientlist = new List<RosterNew.User>();
                clientCaseNote.ParentContactInfoList = new List<ParentInfo>();
                ...
                if (_dataset != null && _dataset.Tables.Count > 0)
                {
                    ...
                    if (_dataset.Tables[1] != null && _dataset.Tables[1].Rows.Count > 0)
                    {
                        ...
                        clientCaseNote.Enc_HouseholdID = clientCaseNote.CaseNoteList[0].Householid;
                        clientCaseNote.ProgramId = clientCaseNote.CaseNoteList[0].ProgramID;
                        clientCaseNote.CenterID = clientCaseNote.CaseNoteList[0].CenterId;
                        clientCaseNote.ClassroomID = clientCaseNote.CaseNoteList[0].Classroomid;
                        clientCaseNote.Enc_ClientID = clientCaseNote.CaseNoteList[0].clientid;
        ...
        public List<ParentInfo> GetParentInformationByClient(out ChildrenInfo childInfo, string clientId, StaffDetails staff)
        {
            List<ParentInfo> parentContactInfoList = new List<ParentInfo>();
            ...
            try
            {
                ...
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@RoleID",staff.RoleId,DbType.Guid),
                    dbManager.CreateParameter("@UserID",staff.UserId,DbType.Guid),
                    dbManager.CreateParameter("@ClientId",EncryptDecrypt.Decrypt64<long>(clientId),DbType.Int64)

                };

                _dataset = dbManager.GetDataSet("USP_GetParent_Client_InformationByClientId", CommandType.StoredProcedure, parameters);
                ...
                if (_dataset != null && _dataset.Tables.Count > 0)
                {
                    if (_dataset.Tables[0] != null && _dataset.Tables[0].Rows.Count > 0)
                    {
                        parentContactInfoList = (from DataRow dr0 in _dataset.Tables[0].Rows

                                                 orderby dr0["ParentName"].ToString()

                                                 select new ParentInfo
                                                 {
                                                     ParentName = DBNull.Value == dr0["ParentName"] ? string.Empty : Convert.ToString(dr0["ParentName"]),
                                                     PhoneNo = Convert.ToString(dr0["PhoneNumber"]),
                                                     EmailId = DBNull.Value == dr0["EmailId"] ? string.Empty : Convert.ToString(dr0["EmailId"])
                    ...
                    if (_dataset.Tables.Count > 1 && _dataset.Tables[1] != null && _dataset.Tables[1].Rows.Count > 0)
                    {
                        ...
                        childInfo.Enc_ClientId = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[1].Rows[0]["ClientID"]));
                        childInfo.ClientName = Convert.ToString(_dataset.Tables[1].Rows[0]["ClientName"]);
                        childInfo.CenterID = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[1].Rows[0]["CenterId"]));
                        childInfo.CenterName = Convert.ToString(_dataset.Tables[1].Rows[0]["CenterName"]);
                        childInfo.ClassRoomID = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[1].Rows[0]["ClassroomId"]));
                        childInfo.ClassRoomName = Convert.ToString(_dataset.Tables[1].Rows[0]["ClassroomName"]);
                        childInfo.ProgramType = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[1].Rows[0]["ProgramID"]));
                        childInfo.Enc_HouseholdId = EncryptDecrypt.Encrypt64(Convert.ToString(_dataset.Tables[1].Rows[0]["HouseholdID"]));
                    ...
                    if (_dataset.Tables[0] != null && _dataset.Tables[0].Rows.Count > 0)
                    {
                        ...
                        caseNoteByClient.CaseNoteList = (from DataRow dr0 in _dataset.Tables[0].Rows
                                                         select new CaseNote
                                                         {
                                                             ...
                                                             CaseNoteid = Convert.ToString(dr0["CaseNoteID"]),
                                                             Title = Convert.ToString(dr0["Title"]),
                                                             Date = DateTime.Parse(Convert.ToString(dr0["CaseNoteDate"]), new CultureInfo("en-US", true)).ToString("MMMM dd, yyyy"),
        ...
        public RosterNew.Users GetAdditionalStaffCenterClassroomChange(string clientId, string centerId, string classroomId, StaffDetails staff)
        {
            long _trytest = 0;

            RosterNew.Users users = new RosterNew.Users();
            users.UserList = new List<RosterNew.User>();
            ...
            var parameters = new IDbDataParameter[]
            {
                ...
                dbManager.CreateParameter("@RoleID",staff.RoleId,DbType.Guid),
                dbManager.CreateParameter("@UserID",staff.UserId,DbType.Guid),
                dbManager.CreateParameter("@ClientID",long.TryParse(clientId,out _trytest)?clientId:EncryptDecrypt.Decrypt64(clientId),DbType.Int64),
                dbManager.CreateParameter("@CenterId",long.TryParse(centerId,out _trytest)?centerId:EncryptDecrypt.Decrypt64(centerId),DbType.Int64),
                dbManager.CreateParameter("@ClassroomId",long.TryParse(classroomId,out _trytest)?classroomId:EncryptDecrypt.Decrypt64(classroomId),DbType.Int64)
            };

            _dataset = dbManager.GetDataSet("USP_GetAdditionalStaff_Center_Classroom_Change", CommandType.StoredProcedure, parameters);


            if (_dataset != null && _dataset.Tables.Count > 0 && _dataset.Tables[0] != null && _dataset.Tables[0].Rows.Count > 0)
            {
                users.UserList = (from DataRow dr in _dataset.Tables[0].Rows
                                  select new RosterNew.User
                                  {
                                      Id = Convert.ToString(dr["UserID"]),
                                      Name = string.Concat(Convert.ToString(dr["StaffName"]), " ", "(", Convert.ToString(dr["RoleName"]), ")")
                                  }
        ...
        public List<TransitionType> GetTransitionTypeList()
        {

            List<TransitionType> transitionType = new List<TransitionType>();
            try
            {

                

                transitionType = dbManager.GetDataTable("USP_GetTransitionType", CommandType.StoredProcedure).DataTableToList<TransitionType>(new List<string>());
        ...
        public FingerprintsModel.TransitionTypeModel GetTransitionTypeDetailsByClientId(string clientId)
        {

            var transitionTypeModel = new FingerprintsModel.TransitionTypeModel();
            ...
            try
            {
                ...
                transitionTypeModel.TransitionTypeDetail= dbManager.GetDataTable("USP_GetTransitionTypeDetailByClientId", CommandType.StoredProcedure, parameters).DataTableToList<TransitionTypeDetail>(new List<string> {"TransitionTypeDetailId" });
        ...
        public bool SaveTransitionTypeDetail(TransitionTypeDetail transitionTypeDetail,Transition transition)
        {
            bool isRowsAffected = false;
            try
            {
                var parameters = new IDbDataParameter[]
                {
                    ...
                    dbManager.CreateParameter("@RoleId",staff.RoleId,DbType.Guid),
                    dbManager.CreateParameter("@UserId",staff.UserId,DbType.Guid),
                    dbManager.CreateParameter("@ClientId",transitionTypeDetail.FK_ClientId,DbType.Int64),
                    dbManager.CreateParameter("@TransitionTypeDetailId",EncryptDecrypt.Decrypt(transitionTypeDetail.TransitionTypeDetailId),DbType.Int64),
                    dbManager.CreateParameter("@TransitionTypeId",transitionTypeDetail.FK_TransitionTypeId,DbType.Int32),
                    dbManager.CreateParameter("@EnrollmentTransactionId",transitionTypeDetail.FK_EnrollmentTransactionId??"0",DbType.Int64),
                    dbManager.CreateParameter("@TypeOfTransition",transition.TypeOfTransition,DbType.Int32),
                    dbManager.CreateParameter("@TransitionProgramType",EncryptDecrypt.Decrypt64<Int64>(transition.TransProgramTypeID),DbType.Int64),
                    dbManager.CreateParameter("@CenterId",EncryptDecrypt.Decrypt64<Int64>(transition.Enc_CenterID),DbType.Int64),
                    dbManager.CreateParameter("@ClassroomId",EncryptDecrypt.Decrypt64<Int64>(transition.Enc_ClassroomID),DbType.Int64)
                    

                };

                isRowsAffected = dbManager.ExecuteWithNonQuery<bool>("USP_SaveTransitionTypeDetail", CommandType.StoredProcedure, parameters);

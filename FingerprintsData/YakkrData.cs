...
namespace FingerprintsData
{
    public class YakkrData
    {
        ...
        public YakkrEmail SaveYakkrEmailContent(YakkrEmail email,string userid,out string result)
        {
            YakkrEmail emaildetails = new YakkrEmail();
            result = "";
            try
            {
                ...
                command.Parameters.AddWithValue("@RawBody", email.RawBody);
                command.Parameters.AddWithValue("@EmailId", email.EmailId);
                command.Parameters.AddWithValue("@UserId", userid);
                command.Parameters.AddWithValue("@result", ParameterDirection.Output);
                command.CommandText = "SP_SaveYakkrEmailContent";    
              ...
              //  command.Parameters.Add(new SqlParameter("@YakkrId", yakkrId));
                ...
                emaildetails = GetYakkrEmail(_dataset);
        ...
        public YakkrEmail GetYakkrForEmail()
        {
            ...
            try
            {
                ...
                command.Parameters.Clear();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "SP_GetYakkrForEmail";
               ...
               // command.Parameters.Add(new SqlParameter("@result", string.Empty));
                ...
                _dataset = new DataSet();
                DataAdapter.Fill(_dataset);
                email=GetYakkrEmail(_dataset);
                email.Result = command.Parameters["@result"].Value.ToString();
            }
            catch (Exception ex)
            {
                clsError.WriteException(ex);
        ...
        public YakkrEmail GetYakkrEmail(DataSet _dataset)
        {
            YakkrEmail email = new YakkrEmail();
            email.YakkrList = new List<SelectListItem>();
            email.EmailList = new List<YakkrEmail>();
            if (_dataset.Tables[0] != null)
            {
                if (_dataset.Tables[0].Rows.Count > 0)
                {
                    email.YakkrList = (from DataRow dr5 in _dataset.Tables[0].Rows
                                       select new SelectListItem
                                       {
                                           Text = dr5["description"].ToString(),
                                           Value = dr5["emailid"].ToString()
                                       }).ToList();
            ...
            if (_dataset.Tables[1] != null)
            {
                if (_dataset.Tables[1].Rows.Count > 0)
                {
                    email.OtherList = (from DataRow dr5 in _dataset.Tables[1].Rows
                                       select new SelectListItem
                                       {
                                           Text = dr5["description"].ToString(),
                                           Value = dr5["emailid"].ToString()
            ...
            if (_dataset.Tables[2] != null)
            {
                ...
                {
                    email.EmailList = (from DataRow dr in _dataset.Tables[2].Rows
                                       select new YakkrEmail
                                       {
                                           RawBody = dr["RawContent"].ToString(),
                                           Subject = dr["Subject"].ToString(),
                                           Body = dr["EmailBody"].ToString(),
                                           YakkrDescription = dr["Description"].ToString(),
                                           EmailId = Convert.ToInt32(dr["emailid"]),
                                           IsOther=Convert.ToBoolean(dr["isother"]),
                                           IsHaveService = Convert.ToBoolean(dr["IsHaveService"])
                                       }).ToList();
        ...
        public List<string> GetEmailMergeFields(int yakkrid, out string result )
        {
            result = "";
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@emailid", yakkrid));
               // command.Parameters.Add(new SqlParameter("@result", string.Empty));

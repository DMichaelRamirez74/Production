...
namespace FingerprintsData
{
    public class RosterData
    {
        ...
        public Roster GetrosterList(out string totalrecord, string sortOrder, string sortDirection, string Center, string Classroom, int skip, int pageSize, string userid, string agencyid, string roleId)
        {
            Roster _roster = new Roster();
            List<Roster> RosterList = new List<Roster>();
            ...
            try
            {
                ...
                if (_dataset.Tables[2] != null)
                {
                    ...
                    {
                        _roster.AbsenceTypeList = (from DataRow dr5 in _dataset.Tables[2].Rows
                ...
                if (_dataset.Tables[3] != null)
                {
                    ...
                    {
                        _roster.AbsenceReasonList = (from DataRow dr5 in _dataset.Tables[3].Rows
                                                       select new SelectListItem
                                                       {
                ...
                if (_dataset.Tables[4] != null)
                {
                    ...
                    closedList = (from DataRow dr5 in _dataset.Tables[4].Rows

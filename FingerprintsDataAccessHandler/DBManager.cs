...
namespace FingerprintsDataAccessHandler
{
    public class DBManager
    {
        ...
        public T ExecuteWithNonQuery<T>(string commandText, CommandType commandType, IDbDataParameter[] parameters) where T : IConvertible
            {
        ...
        public T ExecuteWithScalar<T>(string commandText, CommandType commandType, IDbDataParameter[] parameters) where T:IConvertible
        {
          //  lastId = 0;
            using (var connection = database.CreateConnection())
            {
        ...
        public void TransactionWithIsolationLevel(string commandText, CommandType commandType, IsolationLevel isolationLevel, IDbDataParameter[] parameters)
        {
            IDbTransaction transactionScope = null;
            using (var connection = database.CreateConnection())
            {

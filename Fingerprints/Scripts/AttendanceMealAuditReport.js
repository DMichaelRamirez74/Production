...
function attendanceMealAuditReport() {


    var self = null;
    var _attendanceMealAuditReport = {

        classroomsJson: null,
        getReportUrl: HostedDir + '/Reporting/GetAttendanceMealAuditReport',
        getReportByCenterUrl: HostedDir + '/Reporting/GetAttendanceMealAuditReportByCenter',
    ...
    return _attendanceMealAuditReport;
...
$(function () {
    ...
    attendanceMealAuditReport().init();
